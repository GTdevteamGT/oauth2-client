...
import { AuthorizationCodeRequest, ClientCredentialsRequest, IntrospectionRequest, IntrospectionResponse, OAuth2TokenTypeHint, PasswordRequest, RefreshRequest, RevocationRequest, TokenResponse } from './messages.js';
...
export declare enum OAuth2Endpoint {
...
export declare class OAuth2Client {
     ...
     */
    request(endpoint: OAuth2Endpoint.TokenEndpoint, body: RefreshRequest | ClientCredentialsRequest | PasswordRequest | AuthorizationCodeRequest): Promise<TokenResponse>;
    request(endpoint: OAuth2Endpoint.IntrospectionEndpoint, body: IntrospectionRequest): Promise<IntrospectionResponse>;
    request(endpoint: OAuth2Endpoint.RevocationEndpoint, body: RevocationRequest): Promise<void>;
    /**
