...
import { OAuth2TokenTypeHint, } from './messages.js';
export var OAuth2Endpoint;
(function (OAuth2Endpoint) {
    OAuth2Endpoint["TokenEndpoint"] = "tokenEndpoint";
    OAuth2Endpoint["AuthorizationEndpoint"] = "authorizationEndpoint";
    OAuth2Endpoint["DiscoveryEndpoint"] = "discoveryEndpoint";
    OAuth2Endpoint["IntrospectionEndpoint"] = "introspectionEndpoint";
    OAuth2Endpoint["RevocationEndpoint"] = "revocationEndpoint";
...
export class OAuth2Client {
    ...
    async clientCredentials(params) {
        ...
        if ((params === null || params === void 0 ? void 0 : params.extraParams)
     ...
     */
    async revoke(token, tokenTypeHint = OAuth2TokenTypeHint.AccessToken) {
    ...
    async tokenResponseToOAuth2Token(resp) {
        ...
        if (!(body === null || body === void 0 ? void 0 : body.external) || !(body === null || body === void 0 ? void 0 : body.internal)) {
        ...
        return {
            external: {
                token: body === null || body === void 0 ? void 0 : body.external.access_token,
                expiresAt: Date.now() + (body === null || body === void 0 ? void 0 : body.external.expires_in) * 1000,
                type: body === null || body === void 0 ? void 0 : body.external.token_type,
            },
            internal: {
                token: body === null || body === void 0 ? void 0 : body.internal.access_token,
                expiresAt: Date.now() + (body === null || body === void 0 ? void 0 : body.internal.expires_in) * 1000,
                type: body === null || body === void 0 ? void 0 : body.internal.token_type,
            },
        };
    }
}
