...
declare enum OAuth2ResponseType {
    Code = "code",
    Token = "token"
}
declare enum OAuth2ResponseMode {
    Query = "query",
    Fragment = "fragment"
}
...
declare enum OAuth2CodeChallengeMethod {
    S256 = "S256",
    Plain = "plain"
}
export declare enum OAuth2TokenTypeHint {
